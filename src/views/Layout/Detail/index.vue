<script setup>
import { getDetailServer } from '@/api/detail'
...
const getGoodList = async (id) => {
  const res = await getDetailServer(id)
  console.log(res.result)
  goodsList.value = res.result
}

onMounted(() => {
  getGoodList(route.params.id)
})
</script>
    ...
    <div class="container">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item
            :to="{ path: `/categories/${goodsList.categories?.[0].id}` }"
            v-if="goodsList"
            >{{ goodsList.categories?.[0].name }}
          </el-breadcrumb-item>
          <el-breadcrumb-item
            :to="{ path: `/categories/sub/${goodsList.categories?.[1].id}` }"
            v-if="goodsList.categories"
            >{{ goodsList.categories?.[0].name }}
          </el-breadcrumb-item>
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                  <img
                    v-for="index in goodsList.details?.pictures"
                    :key="index"
                    v-lazyLoad="index"
